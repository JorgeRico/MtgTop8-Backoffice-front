import SelectGroupText from '@/components/Dropdowns/SelectGroup/Text/SelectGroupText';
...
const DropdownText = ({ options, label, name, selectedOption, isOptionSelected, onChangeSubmit, disabled }: DropdownProps) => {
    return (
        <>
